        ...
        <form action="{{ route('search_member') }}" method="GET">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mr-auto mb-1">
                    <button class="btn btn-danger delete_all" role="button" 
                    data-url="{{ url('admin/manage-member/delete-all-member') }}">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 ml-auto searchAdmin mb-1">
                    <div class="form-group inputSearch">
                        <select data-live-search="true" title="Nhập sđt để tìm kiếm" class="form-control selectpicker" name="phone_search">
