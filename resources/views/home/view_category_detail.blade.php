...
<style>
    ...
    @media screen and (max-width: 600px) {
        ...
        .media .media-body .btn-outline-warning {
            font-size: 10px;
            padding: 3px;
        }

        .media .media-body .btn-outline-danger {
            font-size: 10px;
            padding: 3px;
        }
    }
...
<div class="container" style="padding-top:15px;margin-top:60px;padding:5px;">
    <div class="row">
        <div class="col-sm-12">
            ...
            <!-- search -->
            <form action="{{ url('search-quick-category') }}" method="GET">
                <div class="card search-quick" style="margin-bottom:10px;">
                    <div class="card-header" style="background-color:white;padding:10px;">
                        <b><img src="{{ url('public/icons/tim-kiem.png') }}" class="image-icon-index">&ensp;Tìm kiếm nhanh</b>
                    </div>
                    <div class="card-body" style="padding:5px;">
                        <div class="row">

                            <div class="col-12 col-sm-12 col-md-2 col-lg-2" style="padding-right:1px;">
                                <select id="state" class="form-control selectpicker" data-live-search="true" name="input_province">
                            ...
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 district" style="padding-left:1px;">
                                <select id="city" class="form-control" name="input_district">
                            ...
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 category" style="padding-left:1px;padding-right:1px;">
                                <select class="selectpicker form-control" data-live-search="true" data-show-content="true" style="z-index:5;" name="input_id_category">
                                    <option data-content="<i class='far fa-list-alt'></i> Tất cả danh mục" value="">
                                        Tất cả danh mục
                                    </option>
                                    @php
                                    $category_child_firsts = DB::table('category_child_firsts')->get();
                                    @endphp
                                    @foreach ($category_child_firsts as $get_category)
                                    <option value="{{ $get_category->id }}">
                                        {{ $get_category->category_child_name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 search" style="padding-left:1px;">
                                <div class="input-group">
                                    <select class="form-control form-control-xs selectpicker" data-size="7" data-live-search="true" data-title="Nhập chọn tìm kiếm ..." id="state_list" data-width="80%" name="input_title">
                                        @php
                                        $get_post_news = DB::table('post_news')->get();
                                        @endphp
                                        @foreach ($get_post_news as $get_post_new)
                                        <option value="{{ $get_post_new->title }}">
                                            {{ Str::limit($get_post_new->title, 30,'...') }}
                                        </option>
                                        @endforeach
                                    </select>
            ...
            <ul class="breadcrumb breadcrumb-mobile" style="background-color:white;border:1px solid #e5e5e5;">
                ...
                <li class="breadcrumb-item">
                    ...
                    <a href="{{ url('danh-muc/'.$item_category->category_name.'/'.$item_category->id) }}" style="text-decoration:none;color:#ffdf00;font-weight: bold;">{{ $item_category->category_name }}</a>
                    @endforeach
                </li>
                ...
                <div class="card-body" style="padding:5px;">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-8 col-lg-8 text-right">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                        <a href="{{ url('public/upload_images_post_new/'.$photo) }}">
                                            <img class="reponsive" src="{{ url('public/upload_images_post_new/'.$photo) }}" width="600" height="450">
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="text-left" style="margin:10px;">
                                ...
                                <div class="clearfix">
                                    ...
                                    <span class="float-right">
                                        <a class="btn btn-outline-danger btn-sm" href="{{ url('save-post-new/'.$item_postNew->id.'/'.$item_postNew->save_post) }}" role="button" title="lưu tin">
                                            Lưu tin <i class="far fa-heart"></i>
                                        </a>
                                    </span>
                                    @else
                                    <span class="float-right">
                                        <a class="btn btn-outline-danger btn-sm" href="{{ url('save-post-new/'.$item_postNew->id.'/'.$item_postNew->save_post) }}" role="button" title="Bỏ lưu tin">
                                            Lưu tin <i class="far fa-heart"></i>
                                        </a>
                                    </span>
                                    @endif
                                ...
                                <div class="media p-3 user-icon">
                                    ...
                                    <img src="{{ $item_user->avatar }}" style="max-width:100%;height:70px;" class="mr-3 mt-1 rounded-circle"> ​
                                    @elseif($item_user->google_id != NULL)
                                    <img src="{{ $item_user->avatar }}" style="max-width:100%;height:70px;" class="mr-3 mt-1 rounded-circle">
                                    @elseif($item_user->avatar != NULL)
                                    <img src="{{ url('public/upload_images_avatar/'.$item_user->avatar) }}" style="max-width:100%;height:70px;" class="mr-3 mt-1 rounded-circle">
                                    @else
                                    <img src="{{ url('public/logo/user/user-icon-edit.png') }}" style="max-width:100%;height:70px;" class="mr-3 mt-1 rounded-circle">
                                    @endif

                                    <div class="media-body">
                                        <h4>
                                            {{ $item_user->username }}<br>
                                            <b>{{ $item_user->phone }}</b>
                                        </h4>
                            ...
                            {{-- một số danh mục cấp 2  --}}
                            <div class="row">
                                <div class="col-12 col-md-12 ml-2 text-left mb-0">
                                    @php
                                    $category_child_seconds = DB::table('category_child_seconds')->where('id', $item_postNew->category_second_id)->get();
                                    @endphp
                                    {{-- get_categorys  --}}
                                    @foreach($category_child_seconds as $key => $categorys)

                                    {{-- =====================================  --}}
                                    {{-- Bất động sản  --}}
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->estate_category != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class="fa fa-home" style='font-size:17px'></i> Loại bất động sản:</strong>
                                            <span>{{ $categorys->estate_category }}</span>
                                        </div>
                                        @elseif ($categorys->estate_address != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class="fa fa-map-marker"></i> Địa chỉ:</strong></label>
                                            <span>{{ $categorys->estate_address }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->estate_name_project != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-gift' style='font-size:15px'></i> Tên dự án:</strong></label>
                                            <span>{{ $categorys->estate_name_project }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->estate_land_area != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class="fa fa-area-chart"></i> Diện tích đất:</strong></label>
                                            <span>{{ $categorys->estate_land_area }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->estate_floor != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-vihara' style='font-size:15px'></i> Tầng/lầu:</strong></label>
                                            <span>{{ $categorys->estate_floor }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->estate_bedroom != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-bed' style='font-size:15px'></i> Phòng ngủ:</strong></label>
                                            <span>{{ $categorys->estate_bedroom }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->estate_bathroom != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-bath' style='font-size:18px'></i> Phòng tắm:</strong></label>
                                            <span>{{ $categorys->estate_bathroom }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->estate_area_used != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class="fa fa-area-chart"></i> Diện tích sử dụng:</strong></label>
                                            <span>{{ $categorys->estate_area_used }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->estate_juridical != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class="fa fa-shirtsinbulk"></i> Pháp lý:</strong></label>
                                            <span>{{ $categorys->estate_juridical }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->car_version != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class="fa fa-cogs" style="font-size:18px;"></i> Phiên bản:</strong></label>
                                            <span>{{ $categorys->car_version }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->car_color != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-shapes' style='font-size:18px'></i> Màu xe:</strong></label>
                                            <span>{{ $categorys->car_color }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->car_origin != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-synagogue'></i> Xuất xứ:</strong></label>
                                            <span>{{ $categorys->car_origin }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->car_status != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-tags' style='font-size:16px'></i> Trạng thái:</strong></label>
                                            <span>{{ $categorys->car_status }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->car_produce_name != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-warehouse' style="font-size:16px;"></i> Hãng sản xuất:</strong></label>
                                            <span>{{ $categorys->car_produce_name }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->car_model_name != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-tools' style='font-size:18px'></i> Dòng xe:</strong></label>
                                            <span>{{ $categorys->car_model_name }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->car_register_year != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='far fa-calendar-check' style="font-size:20px;"></i> Năm đăng ký:</strong></label>
                                            <span>{{ $categorys->car_register_year }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->car_category != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-car' style='font-size:18px'></i> Loại xe:</strong></label>
                                            <span>{{ $categorys->car_category }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->car_number_kilometer != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-tram' style='font-size:18px'></i> Số Km đã đi:</strong></label>
                                            <span>{{ $categorys->car_number_kilometer }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->car_fuel != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-gas-pump' style='font-size:18px'></i> Nhiên liệu:</strong></label>
                                            <span>{{ $categorys->car_fuel }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->car_image_register_paper != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                            ...
                                            <span>
                                                <img src="{{ url('public/upload_image_paper_register/'.$categorys->car_image_register_paper) }}" class="image-papper-register" id="myImg">
                                            </span>
                                        </div>
                                        @else
                                        @endif
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->electron_manufacturer != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                                <i class='fas fa-warehouse' style='font-size:15px'></i>
                                                Hãng sản xuất:
                                            </strong <span>{{ $categorys->electron_manufacturer }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->electron_model_machine != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-industry' style='font-size:16px'></i> Dòng máy:</strong></label>
                                            <span>{{ $categorys->electron_model_machine }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->electron_color != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-shapes' style='font-size:18px'></i> Màu sắc:</strong></label>
                                            <span>{{ $categorys->electron_color }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->electron_status != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-exclamation-triangle' style='font-size:16px'></i> Trạng thái:</strong></label>
                                            <span>{{ $categorys->electron_status }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->work_type != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='far fa-id-card' style='font-size:16px'></i> Loại hình làm việc:</strong></label>
                                            <span>{{ $categorys->work_type }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->work_old != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-id-card-alt' style='font-size:16px'></i> Độ tuổi:</strong></label>
                                            <span>{{ $categorys->work_old }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->work_sex != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-restroom' style='font-size:15px'></i> Giới tính:</strong></label>
                                            <span>{{ $categorys->work_sex }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->work_foreign_language != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-user-tie' style='font-size:17px'></i> Ngoại ngữ:</strong></label>
                                            <span>{{ $categorys->work_foreign_language }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->work_certificate != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-user-graduate' style='font-size:17px'></i> Bằng cấp:</strong>
                                            <span>{{ $categorys->work_certificate }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->work_position != null)
                                        <div class="form-group col-md-6">
                                            <label><strong><i class='fas fa-user-tag' style='font-size:17px'></i> Vị trí:</strong></label>
                                            <span>{{ $categorys->work_position }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->work_experience != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-user-clock' style='font-size:17px'></i> Kinh nghiệm:</strong>
                                            <span>{{ $categorys->work_experience }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->work_job != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-user-md' style='font-size:17px'></i> Nghề nghiệp:</strong>
                                            <span>{{ $categorys->work_job }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-row">
                                        @if ($categorys->work_salary_level != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-id-card' style='font-size:17px'></i> Mức lương:</strong>
                                            <span>{{ number_format($categorys->work_salary_level) }} Đ</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->food_origin != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-bread-slice' style='font-size:16px'></i> Xuất xứ:</strong>
                                            <span>{{ $categorys->food_origin }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->food_expiration != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-stopwatch' style='font-size:18px'></i> Hạn sử dụng:</strong>
                                            <span>{{ $categorys->food_expiration }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->refrigerator_status != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                                <i class='fas fa-exclamation-triangle' style='font-size:18px'></i> Tình trạng:
                                            </strong>
                                            <span>{{ $categorys->refrigerator_status }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->refrigerator_manufacturer != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-building' style='font-size:18px'></i> Hãng sản xuất:</strong>
                                            <span>{{ $categorys->refrigerator_manufacturer }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->furniture_status != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                                <i class='fas fa-exclamation-triangle' style='font-size:18px'></i> Tình trạng:
                                            </strong>
                                            <span>{{ $categorys->furniture_status }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->fashion_status != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-exclamation-triangle' style='font-size:18px'></i> Tình trạng:</strong>
                                            <span>{{ $categorys->fashion_status }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->fashion_type_product != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-tshirt' style='font-size:17px'></i> Loại sản phẩm:</strong>
                                            <span>{{ $categorys->fashion_type_product }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->sport_status != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                                <i class='fas fa-exclamation-triangle' style='font-size:18px'></i> Tình trạng:
                                            </strong>
                                            <span>{{ $categorys->sport_status }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->office_furniture_status != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                                <i class='fas fa-exclamation-triangle' style='font-size:18px'></i> Tình trạng:
                                            </strong>
                                            <span>{{ $categorys->office_furniture_status }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->service_type_work != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='far fa-id-card' style='font-size:16px'></i> Loại hình làm việc:</strong>
                                            <span>{{ $categorys->service_type_work }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->service_experience_work != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                                <i class='fas fa-user-clock' style='font-size:17px'></i> Kinh nghiệm làm việc:
                                            </strong>
                                            <span>{{ $categorys->service_experience_work }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                                    ...
                                    {{-- =====================================  --}}
                                    <div class="form-row">
                                        @if ($categorys->mom_baby_status != null)
                                        <div class="form-group col-md-6">
                                            <strong>
                                                <i class='fas fa-exclamation-triangle' style='font-size:18px'></i> Tình trạng:
                                            </strong>
                                            <span>{{ $categorys->mom_baby_status }}</span>
                                        </div>
                                        @else
                                        @endif

                                        @if ($categorys->mom_baby_type_product != null)
                                        <div class="form-group col-md-6">
                                            <strong><i class='fas fa-tshirt' style='font-size:17px'></i> Loại sản phẩm:</strong>
                                            <span>{{ $categorys->mom_baby_type_product }}</span>
                                        </div>
                                        @else
                                        @endif
                                    </div>
                            ...
                            <div class="social">
                                ...
                                <div class="text-left" style="margin:10px;">
                                    ...
                                    <div class="fb-share-button" data-href="http://localhost/raoban/view-category-detail/" data-layout="button" data-size="small">
                                        <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%2Fraoban%2Fview-category-detail%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a>
                                    </div>

                                    <br>

                                    <div class="zalo-share-button mt-2" data-href="https://caythuoccamau.vn/view_medicinal_herbs/24" data-oaid="608599106084157957" data-layout="1" data-color="blue" data-customize=false></div>


                                    {{-- <span class="fb-share-button" data-href="https://caythuoccamau.vn/view_medicinal_herbs/24" data-layout="button_count" data-size="large">
                                        ​<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%2Fraoban%2Fview-category-detail%2F&amp;src=sdkpreparse">
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 text-left">
                            <div class="card post-new" style="margin-bottom:10px;">
                                <div class="card-header" style="background-color:white;padding:5px;">
                                    <b class="b-text">
                                        <img src="{{ url('public/icons/tin-moi-nhat.png') }}" class="image-icon-index">
                                        <span style="color:gray;">Tin rao bán tương tự</span>
                                    </b>
                                </div>
                                @if($likePostNew->count() != null)
                                <div class="card-body" style="padding:5px;">
                                    @foreach ($likePostNew as $item_likePostNew)
                                    <a href="{{ url('view-category-detail/'.Str::slug($item_likePostNew->title), $item_likePostNew->id) }}" style="text-decoration:none;color:#ff3333;">
                                        <div class="media">
                                            @php
                                            ...
                                            @if ($loop->first)
                                            <img src="{{ url('public/upload_images_post_new/'.$picture) }}" class="img-fluid mr-1 image-post-new" style="width: 100px;">
                                            @endif
                                            @endforeach
                                            <div class="media-body">
                    ...
                    if (!Object.keys) {
                        Object.keys = function(o, // object k, // key r // result array ) { // initialize object and result r=[]; // iterate over object keys for (k in o) // fill result array with non-prototypical keys r.hasOwnProperty.call(o, k) && r.push(k); // return result return r; }; } // set data-selected on select element if the value has been programmatically selected // prior to initialization of bootstrap-select // * consider removing or replacing an alternative method * var valHooks={ useDefault: false, _set: $.valHooks.select.set, }; $.valHooks.select.set=function(elem, value) { if (value && !valHooks.useDefault) $(elem).data('selected', true); return valHooks._set.apply(this, arguments); }; var changed_arguments=null; $.fn.triggerNative=function(eventName) { var el=this[0], event; if (el.dispatchEvent) { // for modern browsers & IE9+ if (typeof Event==='function' ) { // For modern browsers event=new Event(eventName, { bubbles: true, }); } else { // For IE since it doesn't support Event constructor event=document.createEvent('Event'); event.initEvent(eventName, true, false); } el.dispatchEvent(event); } else if (el.fireEvent) { // for IE8 event=document.createEventObject(); event.eventType=eventName; el.fireEvent('on' + eventName, event); } else { // fall back to jQuery.trigger this.trigger(eventName); } }; //</editor-fold>
                                ...
                                var generateA = function(content, index, classes, optgroup) {
                                    ...
                                    return '<a tabindex="0"' +
                                        ((typeof classes !== ' undefined' && '' !== classes) ? ' class="' + classes + '"' : '') + ((typeof index !== 'undefined' && null !== index) ? ' data-original-index="' + index + '"' : '') + ((typeof optgroup !== 'undefined' && null !== optgroup) ? 'data-optgroup="' + optgroup + '"' : '') + '>' + content + '</a>';
                                };
                                ...
                                /** * @param text * @param [classes] * @param [inline] * @param [tokens] * @returns {string} */
                                var generateSpan = function(text, classes, inline, tokens) { // support bootstrap v4: http://v4-alpha.getbootstrap.com/components/dropdowns/#single-button-dropdowns classes='dropdown-item-inner ' + (classes || '' ); return '<span' + (typeof classes !=='undefined' ? ' class="' + classes + '"' : '' ) + (inline ? ' style="' + inline + '"' : '' ) + (that.options.liveSearchNormalize ? ' data-normalized-text="' + normalizeToBase(htmlEscape($(text).html())) + '"' : '' ) + (typeof tokens !=='undefined' || tokens !==null ? ' data-tokens="' + tokens + '"' : '' ) + ' role="option">' + text + '<span class="' + that.options.iconBase + ' ' + that.options.tickIcon + ' check-mark"></span>' + '</span>' ; }; if (this.options.title && !this.multiple) { // this option doesn't create a new <li> element, but does add a new option, so liIndex is decreased
                            ...
                            setSize: function() {
                                ...
                                if (this.options.size === 'auto') {
                                    ...
                                    if (that.options.dropupAuto) {
                                        ...
                                        this.$newElement.toggleClass('dropup', selectOffsetTop > selectOffsetBot && (menuHeight - menuExtras.vert) <
                                            getHeight);
                                    }
                                    $menu.css({
