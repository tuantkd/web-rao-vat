          ...
          <div class="card category-mobile" style="margin-bottom:10px;">
            ...
            <div class="card-body" style="padding:10px;">
              <div class="row">
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                  <a href="" style="text-decoration:none;"><b style="color:red;">Nội thất, đồ chơi Ô tô</b></a>
                  13,23
                </div>
                ...
                <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                  <a href="" style="text-decoration:none;"><b style="color:red;">Mũ bảo hiểm xe máy</b></a> 10,292
                </div>
            ...
            <div class="card-body" style="padding:5px;">
              <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                  <a href="" style="text-decoration:none;color:#ff3333;">
                    <div class="media">
                      <img src="public/images/car-4.jpg" class="align-self-start mr-3"
                        style="width:110px;height:80px;border-radius:5px;">
                      <div class="media-body">
                        <b>Xe Kia Morning 2020 - thời trang -hiện đại</b>
                        <p style="color:black;font-size:12px;">
