        ...
        <div class="col-sm-12">
                ...
                <div class="card-body" style="padding:10px;">
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4">
                            <a href="{{ url('danh-muc-tiep-theo/'.Str::slug($item_category_first->category_child_name).'/'.$item_category_first->id) }}" style="text-decoration:none;">
                                <b style="color:#ffdf00;text-shadow: 0.1px 0.1px 0.1px gray">{{ $item_category_first->category_child_name}}</b>
                            </a>
                            @php
                            $count = DB::table('post_news')
                            ->where([
                            ['category_first_id','=',$item_category_first->id],
                            ['status','=',1]
                            ])->count();
                            @endphp
                            {{ $count }}
            ...
            <div class="card post-new" style="margin-bottom:10px;z-index:2px;">
                ...
                <div class="card-body p-2">
                    <div class="row">
                        @foreach ($category_first as $first)
                        @php
                        $postNewVip = DB::table('post_news')->where([['category_first_id', '=',$first->id],['status', '=',2]
                        ])->paginate(18);
                        @endphp
                        @foreach ($postNewVip as $itemPostNew)
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            <a href="{{ url('view-category-detail/'.Str::slug($itemPostNew->title).'/'. $itemPostNew->id) }}" style="text-decoration:none;color:orange;">
                                <div class="media p-1 m-1">
                                    ...
                                    @if ($loop->first)
                                    <img src="{{ url('public/upload_images_post_new/'.$picture) }}" class="responsive mr-1">
                                    @endif
                                    @endforeach

                                    <div class="media-body pl-1">
                                        <b style="font-size: 14px;" class="text-danger">
                                            <span style="color:#ffdf00;">{{ $itemPostNew->title }}</span>
                                        </b>
                                        <p class="p-text">
                                            @php
            ...
            <div class="card post-new" style="margin-bottom:10px;z-index:2px;">
                <div class="card-header" style="background-color:white;padding:10px;">
                    <b class="b-text">
                        ...
                        <span style="color:gray;">Tin rao bán mới nhất</span>
                    </b>
                </div>

                <div class="card-body" style="padding:5px;">
                    <div class="row">
                        @foreach ($category_first as $first_2)
                        @php
                        $postNew = DB::table('post_news')->where([
                        ['category_first_id', '=',$first_2->id],
                        ['status', '=',1]
                        ])->paginate(18);
                        @endphp
                                        ...
                                        this.$menuInner.on('click', 'a', function(e) {
                                            ...
                                            changeAll: function(status) {
                                                ...
                                                var $this = $(this)
                                                    ...
                                                    , index, prevIndex, isActive, selector = ':not(.disabled, .d-none, .dropdown-header, .dropdown-divider)'
                                                    , keyCodeMap = {
                                                        32: ' '
                                                        , 48: '0'
                                                        , 49: '1'
