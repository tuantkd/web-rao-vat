@extends('layout.layout_home') @section('title', 'Xem danh mục tiếp theo')
<!-- ==================================================== -->
...
<style>
    ...
    .card-body .row .upload-post-new .a-link-image {
        color: #ffdf00;
        font-weight: bold;
    }
        ...
        <div class="col-sm-12">
            ...
            <form action="{{ url('search-quick-category') }}" method="GET">
                <div class="card search-quick" style="margin-bottom:10px;">
                    <div class="card-header" style="background-color:white;padding:10px;color:gray;text-shadow: 0.4px 0.4px 0.4px gray;">
            ...
            <ul class="breadcrumb breadcrumb-mobile" style="background-color:white;border:1px solid #e5e5e5;">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ url('danh-muc/'.Str::slug($value->category_name).'/'.$value->id) }}" style="text-decoration:none;color:#ffdf00;font-weight: bold;">
                        {{ $value->category_name }}
                    </a>
                </li>
            ...
            <div class="card category-mobile" style="margin-bottom:10px;">
                <div class="card-header" style="background-color:white;padding:10px;color:gray;text-shadow: 0.4px 0.4px 0.4px gray;">
                    @foreach ($category_first as $item_category_first)
                    @if($value->id == 1)
                    <b><img src="{{ url('public/icons/bat-dong-san.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 2)
                    <b><img src="{{ url('public/icons/xe-co.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 3)
                    <b><img src="{{ url('public/icons/dien-tu.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 4)
                    <b><img src="{{ url('public/icons/viec-lam.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 5)
                    <b><img src="{{ url('public/icons/thu-cung.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 6)
                    <b><img src="{{ url('public/icons/thuc-pham.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 7)
                    <b><img src="{{ url('public/icons/may-lanh.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 8)
                    <b><img src="{{ url('public/icons/do-van-phong.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 9)
                    <b><img src="{{ url('public/icons/thoi-trang.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 10)
                    <b><img src="{{ url('public/icons/the-thao.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 11)
                    <b><img src="{{ url('public/icons/van-phong.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @elseif($value->id == 12)
                    <b><img src="{{ url('public/icons/dich-vu.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @else
                    <b><img src="{{ url('public/icons/me-be.png') }}" class="image-icon-index">&ensp;{{ $value->category_name }}</b>
                    @endif
                    @endforeach
                </div>
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4">
                            <a href="{{ route('view_category_first', [ Str::slug($item_allCategoryFirst->category_child_name),$item_allCategoryFirst->id]) }}" style="text-decoration:none;">
                                <b style="color:#ffdf00;">
                                    {{ $item_allCategoryFirst->category_child_name}}
                                </b>
                            </a>
                            @php
                            $count = DB::table('post_news')
                            ->where([
                            ['category_first_id','=',$item_allCategoryFirst->id],
                            ['status','=',1]
                            ])->count();
                            @endphp
                            {{ $count }}
            ...
            <div class="card post-new" style="margin-bottom:10px;z-index:2px;">
                <div class="card-header" style="background-color:white;padding:10px;">
                    <b class="b-text">
                        <img src="{{ url('public/icons/tin-vip.png') }}" class="image-icon-index">
                        <span style="color:gray;">Tin rao bán VIP</span>
                    </b>
                </div>
                <div class="card-body" style="padding:5px;">
                    <div class="row">
                        @php
                        $CategoryFirstVIP = DB::table('category_child_firsts')->where('category_id', '=',$value->id)->get();
                        @endphp
                        @foreach ($CategoryFirstVIP as $first)

                        @php
                        $postNewCategoryFirstVIP = DB::table('post_news')->where([['category_first_id', '=',$first->id],['status', '=',2]
                        ])->paginate(18);
                        @endphp
                        @foreach ($postNewCategoryFirstVIP as $item_postNewCategoryFirst)
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            <a href="{{ url('view-category-detail/'.Str::slug($item_postNewCategoryFirst->title), $item_postNewCategoryFirst->id) }}" style="text-decoration:none;color:#ffdf00;">
                                <div class="media p-1 mb-1">
                                    ...
                                    @if ($loop->first)
                                    <img src="{{ url('public/upload_images_post_new/'.$picture) }}" class="align-self-start mr-1">
                                    @endif
                                    @endforeach
                                    ...
                                    <div class="media-body pl-1">
                                        ...
                                        <p class="p-text">
                                            ...
                                            ->where('id', $item_postNewCategoryFirst->province_id)->get();
                                            $district = DB::table('districts')->where('id', $item_postNewCategoryFirst->district_id)->get();
                                            @endphp
                                            @foreach ($province as $item_province)
                                            @foreach ($district as $item_district)
                                            <i class="fas fa-map-marker-alt"></i> {{ $item_province->province_name }}
                                            / {{ $item_district->district_name }} <br>
                                            @endforeach
                                            @endforeach
            ...
            <div class="card post-new" style="margin-bottom:10px;z-index:2px;">
                <div class="card-header" style="background-color:white;padding:10px;">
                    <b class="b-text">
                        ...
                        @foreach ($category_first as $item_category_first)
                        <span style="color: gray;">{{ $item_category_first->category_child_name }}</span>
                        @endforeach
                    </b>
                </div>
                @if($postNewCategoryFirst->count() != null)
                <div class="card-body" style="padding:5px;">
                    <div class="row">
            ...
            <div class="card post-new-category" style="margin-bottom:10px;">
                <div class="card-header" style="background-color:white;padding:10px;text-align:center;">
                    <b class="b_text">
                        <span style="color: gray;">
                            <img src="{{ url('public/icons/upload-dang-tin.png') }}" class="image-icon-index">
                ...
                <div class="card-body" style="padding:15px;padding-top:5px;">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 upload-post-new mt-3">

                            @if($value->id == 1)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/bat-dong-san.png') }}" class="image-icon-index"> Bất động sản
                            </a>
                            @elseif($value->id == 2)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/xe-co.png') }}" class="image-icon-index"> Xe cộ
                            </a>
                            @elseif($value->id == 3)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/dien-tu.png') }}" class="image-icon-index"> Đồ điện tử
                            </a>
                            @elseif($value->id == 4)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/viec-lam.png') }}" class="image-icon-index"> Việc làm
                            </a>
                            @elseif($value->id == 5)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/thu-cung.png') }}" class="image-icon-index"> Thú cưng
                            </a>
                            @elseif($value->id == 6)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                            ...
                            @elseif($value->id == 8)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/do-van-phong.png') }}" class="image-icon-index">
                                Đồ gia dụng, và loại khác
                            </a>
                            @elseif($value->id == 9)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/thoi-trang.png') }}" class="image-icon-index">
                                Thời trang, đồ dùng
                            </a>
                            @elseif($value->id == 10)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/the-thao.png') }}" class="image-icon-index">
                            ...
                            @elseif($value->id == 13)
                            <a href="{{ url('post-new/'.Str::slug($value->category_name).'/'.$value->id )}}" class="a-link-image">
                                <img src="{{ url('public/icons/me-be.png') }}" class="image-icon-index"> Mẹ và bé
                            </a>
                            @endif
